...
/**
 * Contract for determining metadata about a domain entity persisted to an
 * Airtable table.
 */
public interface AirtableEntityInformationProvider {
    /**
     ...
     *
     * @return An {@link AirtableEntityInformation}.
     */
    <T> AirtableEntityInformation<T> getEntityInformation(final Class<T> domainClass);
}
